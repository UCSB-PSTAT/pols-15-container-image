            ...
            stages{
                ...
                stage('Test') {
                    steps {
                        ...
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"tidyverse\");library(\"knitr\");library(\"WDI\");library(\"faraway\");library(\"foreign\");library(\"reshape2\");library(\"boot\");library(\"car\");library(\"datasets\");library(\"pscl\");library(\"vcd\");library(\"stargazer\");library(\"MASS\");library(\"arm\");library(\"readstata13\");library(\"readxl\");library(\"countrycode\")"'
